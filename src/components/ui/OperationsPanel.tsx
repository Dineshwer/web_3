        ...
        <aside className={styles.opsPanel}>
            ...
            <div className={styles.opsSection}>
                ...
                <div className={styles.actionGrid}>
                    <button className={styles.actionButton} onClick={() => addLog('> INITIATING_DEEP_SCAN...')}>SCAN_NET</button>
                    <button className={styles.actionButton} onClick={() => addLog('> PURGING_CACHE...')}>PURGE_LOGS</button>
                    <button className={styles.actionButton} onClick={() => addLog('> REBOOT_SEQUENCE_ARMED')}>REBOOT</button>
                    <button className={`${styles.actionButton} ${styles.danger}`} onClick={() => addLog('> ! LOCKDOWN_INITIATED !')}>LOCKDOWN</button>
                </div>
            </div>
